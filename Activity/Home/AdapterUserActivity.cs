...
{
    public class AdapterUserActivity : BaseAdapter<OrderResponse>
    {
        Context context;
        List<OrderResponse> orders;
        Android.App.FragmentTransaction manager;
        
        public AdapterUserActivity(Context Context, List<OrderResponse> List, FragmentManager Manager)
        {
            this.manager = Manager.BeginTransaction();
            this.context = Context;
            this.orders = List;
        }
        public override OrderResponse this[int position] => orders[position];
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (view == null)
            {
                ...
                btn_order_management.Click += Btn_Click_Order_Management;
        ...
        private void Btn_Click_Order_Management(object sender, EventArgs e)
        {
