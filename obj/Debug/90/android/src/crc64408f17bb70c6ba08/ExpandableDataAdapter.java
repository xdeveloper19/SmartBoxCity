...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"n_onGroupExpanded:(I)V:GetOnGroupExpanded_IHandler\n" +
			...
			"";
		mono.android.Runtime.register ("SmartBoxCity.Activity.Order.ExpandableDataAdapter, SmartBoxCity", ExpandableDataAdapter.class, __md_methods);
	}
	...
	public ExpandableDataAdapter ()
	{
		...
		if (getClass () == ExpandableDataAdapter.class)
			mono.android.TypeManager.Activate ("SmartBoxCity.Activity.Order.ExpandableDataAdapter, SmartBoxCity", "", this, new java.lang.Object[] {  });
	}
