...
namespace EntityLibrary.Model.OrderResponse
{
    ...
    public class OrderObjectResponse<T1, T2, T3> : BaseResponseObject
    {
        public OrderObjectResponse()
        {
            this.ORDER = new OrderParameters();
            this.SENSORS_STATUS = new SensorResponse();
            this.STAGES = new List<T3>();
        }
        public OrderParameters ORDER { get; set; }
        public SensorResponse SENSORS_STATUS { get; set; }
        public List<T3> STAGES { get; set; }
    }
